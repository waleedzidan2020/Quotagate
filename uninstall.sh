...
rm -f /etc/init.d/quotagate /usr/local/sbin/quotagate-network-start /usr/local/sbin/quotagate-network-stop /usr/local/sbin/quotagate-diagnose /usr/local/sbin/quotagate-setup-network /usr/local/sbin/quotagate-make-cert /usr/local/sbin/quotagate-pppoe-test
rm -rf /opt/quotagate
...
echo "QuotaGate removed. Data/config under /var/lib/quotagate and /etc/quotagate were kept intentionally."
