(()=>{
  ...
  load('app-core.js',()=>load('speed-toggle.js',()=>load('guest-shaping.js',()=>load('guest-mode.js',()=>load('quota-ui.js',()=>load('live-usage.js',()=>load('maintenance.js',()=>load('qos-gaming.js'))))))));
})();
